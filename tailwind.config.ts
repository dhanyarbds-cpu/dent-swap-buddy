  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "glow-pulse": {
          "0%, 100%": { boxShadow: "0 0 12px hsl(260 70% 58% / 0.4), 0 0 30px hsl(260 70% 58% / 0.15)" },
          "50%": { boxShadow: "0 0 20px hsl(260 70% 58% / 0.6), 0 0 50px hsl(260 70% 58% / 0.25)" },
        },
      },
      animation: {
