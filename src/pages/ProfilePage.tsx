        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1">
            <div className="flex items-center gap-1.5">
              <h2 className="text-lg font-bold text-primary-foreground">Dental Student</h2>
              <BadgeCheck className="h-5 w-5 text-primary-foreground/80" />
            </div>
            <p className="text-sm text-primary-foreground/70">GDC Mumbai · 3rd Year</p>
            <p className="mt-0.5 text-xs text-primary-foreground/50">Mumbai, Maharashtra</p>
          </div>
        </div>
